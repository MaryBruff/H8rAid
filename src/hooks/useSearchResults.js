...
const useSearchResults = () => {
  ...
  useEffect(() => {
    ...
    const words = ["Controversies", "Controversy", "Hoax", "Criticism", "Scandal", "Legal Issues", "Conspiracy", "Arrest", "Allegation","Allegations", "Dispute", "Disputed", "Abuse", "Criminal", "Banned", "Theft", "Imprisonment", "Censorship"];
